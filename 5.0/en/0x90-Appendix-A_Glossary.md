...
- **오픈 웹 애플리케이션 보안 프로젝트(OWASP)** - OWASP는 애플리케이션 소프트웨어의 보안 증진에 초점을 맞춘 자유롭고 개방적인 커뮤니티이다. 우리의 사명은 애플리케이션 보안을 “가시적”으로 만들어 사람들과 단체들이 애플리케이션 보안 위험에 대해 현명한 선택을 할 수 있도록 하는 것이다. [https://www.owasp.org/](https://www.owasp.org/%EB%A5%BC) 확인.
